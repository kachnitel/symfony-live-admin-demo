 ...
 *     entity_namespace?: scalar|Param|null, // Base namespace for entities // Default: "App\\Entity\\"
 *     form_namespace?: scalar|Param|null, // Base namespace for form types // Default: "App\\Form\\"
 *     form_suffix?: scalar|Param|null, // Suffix for form type classes // Default: "FormType"
 *     route_prefix?: scalar|Param|null, // Route prefix for generic entity CRUD operations // Default: "app_admin_entity"
 *     dashboard_route?: scalar|Param|null, // Dashboard route name // Default: "app_admin_dashboard"
 *     required_role?: scalar|Param|null, // Required role for accessing admin // Default: "ROLE_ADMIN"
 *     base_layout?: scalar|Param|null, // Base layout template (defaults to none, templates extend app layout) // Default: null
 *     enable_generic_controller?: bool|Param, // Enable the generic admin controller with dynamic routes // Default: true
 *     pagination?: array{
 *         default_items_per_page?: int|Param, // Default number of items per page // Default: 20
 *         allowed_items_per_page?: list<int|Param>,
 *     },
 *     theme?: scalar|Param|null, // CSS theme template. Use @KachnitelAdmin/theme/tailwind.html.twig for Tailwind, or provide your own. // Default: "@KachnitelAdmin/theme/bootstrap.html.twig"
 *     archive?: array{ // Global archive/soft-delete filter configuration. Override per-entity with #[Admin(archiveExpression: ...)].
 *         expression?: scalar|Param|null, // ExpressionLanguage expression identifying archived rows (e.g. "item.archived", "item.deletedAt"). Must use item.fieldName format for DB-level filtering. // Default: null
 *         role?: scalar|Param|null, // Role required to toggle the archive filter. Null = any authenticated user. Override per-entity with #[Admin(archiveRole: ...)]. // Default: null
 *     },
 * }
